				...
				.bind('Moved', function()
					{
						...
						if (this.x > currentUpperLeftX + tileWidth)
						{
							...
							Crafty.viewport.pan(tileWidth + canvasEdge*3, 0, panTime);
						...
						{
							currentUpperLeftX = currentUpperLeftX - tileWidth;
							Crafty.viewport.pan((tileWidth + canvasEdge*3)*-1, 0, panTime);
						...
						if (this.y > currentUpperLeftY + tileHeight)
						{
							...
							Crafty.viewport.pan(0, tileHeight + canvasEdge*3, panTime);
						...
						{
							currentUpperLeftY = currentUpperLeftY - tileHeight;
							Crafty.viewport.pan(0, (tileHeight + canvasEdge*3)*-1, panTime);
